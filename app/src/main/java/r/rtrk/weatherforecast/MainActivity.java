...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addCity(new City(getString(R.string.london),getResources().getDrawable(R.drawable.city)));
        adapter.addCity(new City(getString(R.string.lisabon),getResources().getDrawable(R.drawable.city)));
