...
public class DBHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public void insert(WeatherData weatherData) {
        ...
        Log.d("datum", weatherData.getDate());
        //contentValues.put(COLUMN_WEEKDAY, weatherData.getWeekday());
        contentValues.put(COLUMN_TEMPERATURE, weatherData.getTemperature());
        Log.d("temp", Double.toString(weatherData.getTemperature()));
    ...
    public WeatherData readFromDB(String city){
        ...
        cursor.moveToLast();
        //WeatherData(String city, double temperature, double humidity, double pressure, String sunrise, String sunset, double windSpeed, String windDirection, String date)
